...
(function(){
  var T={
    en:{
      ...
      ph_name:'Jane Smith',ph_email:'you@example.com',
      ...
      ph_imap_email:'you@gmail.com',ph_imap_pass:'xxxx xxxx xxxx xxxx'
    },
    es:{
      ...
      ph_name:'Juana Pérez',ph_email:'tu@ejemplo.com',
      ...
      ph_imap_email:'tu@gmail.com',ph_imap_pass:'xxxx xxxx xxxx xxxx'
    }
  };
  ...
  function setLang(l){
    ...
    document.querySelectorAll('[data-i18n-ph]').forEach(function(el){
      ...
      if(T[l][k]!==undefined) el.setAttribute('placeholder', T[l][k]);
    });
    window._lang=l;
  }
